import type { User, Activity, AppNotification } from '@/types'
...
export const mockActivities: Activity[] = [
  {
    ...
    players: [
      { user: mockUsers[0], checkinStatus: 'not_arrived' },
      { user: mockUsers[1], checkinStatus: 'not_arrived' },
      { user: mockUsers[2], checkinStatus: 'arrived', carOfferId: 'co1' },
      { user: mockUsers[3], checkinStatus: 'not_arrived' },
      { user: mockUsers[4], checkinStatus: 'arrived', carOfferId: 'co2' },
      { user: mockUsers[5], checkinStatus: 'not_arrived' },
    ],
    carOffers: [
      {
        id: 'co1',
    ...
    fleetGroups: [
      {
        ...
        cars: [
          ...
          },
          {
            carOfferId: 'co2',
            driver: mockUsers[4],
            passengers: [mockUsers[3], mockUsers[5]],
            route: '西二旗 → 创意大厦',
          },
        ],
        meetingPoint: '学院路创意大厦B2门口',
      ...
      },
      {
        ...
        meetingPoint: '创意大厦B2门口',
        departureTime: '2026-06-21T23:30:00',
      },
    ],
    status: 'recruiting',
  ...
  },
  {
    ...
    players: [
      { user: mockUsers[9], checkinStatus: 'not_arrived' },
      { user: mockUsers[6], checkinStatus: 'not_arrived', carOfferId: 'co3' },
      { user: mockUsers[7], checkinStatus: 'not_arrived' },
      { user: mockUsers[8], checkinStatus: 'not_arrived', carOfferId: 'co4' },
    ],
    carOffers: [
      {
        id: 'co3',
  ...
  },
  {
    ...
    players: [
      { user: mockUsers[1], checkinStatus: 'arrived' },
      { user: mockUsers[0], checkinStatus: 'arrived' },
      { user: mockUsers[3], checkinStatus: 'late' },
      { user: mockUsers[5], checkinStatus: 'arrived' },
      { user: mockUsers[7], checkinStatus: 'not_arrived' },
      { user: mockUsers[9], checkinStatus: 'arrived', carOfferId: 'co5' },
    ],
    carOffers: [
      {
        id: 'co5',
        ...
        cars: [
          {
            carOfferId: 'co5',
            driver: mockUsers[9],
            passengers: [mockUsers[0], mockUsers[3], mockUsers[5], mockUsers[7]],
            route: '知春路 → 中关村',
          },
        ],
        meetingPoint: '知春路地铁站B口',
        departureTime: '2026-06-23T17:30:00',
      },
    ],
    status: 'confirmed',
...
export const mockNotifications: AppNotification[] = [
  {
    ...
    activityId: 'a1',
    type: 'car_offer',
    content: '老司机阿杰 提供了车源（五道口出发，可坐3人）',
    user: mockUsers[2],
  ...
  },
  {
    ...
    activityId: 'a1',
    type: 'checkin',
    content: '老司机阿杰 已到达集合点',
    user: mockUsers[2],
    timestamp: '2026-06-21T17:45:00',
  },
  {
    id: 'n4',
    activityId: 'a3',
    type: 'late',
    content: '剧本猎人 迟到了，预计晚10分钟',
    user: mockUsers[3],
    timestamp: '2026-06-23T17:50:00',
  },
  {
    id: 'n5',
    activityId: 'a3',
    type: 'ride_change',
    content: '密室女王 改坐网约车前往',
    user: mockUsers[7],
